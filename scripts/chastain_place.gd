...
func _jack() -> void:
	...
	jack.setup({
		...
		"mug": true,
		"schedule": [
			{"from": 11.0, "to": 14.0, "at": Vector3(-14.4, STOOP_Y, 11.4),
				"say": ["I just woke up. Don't make it weird.",
					"There's no milk. There was never milk. Stop bringing it up."]},
			{"from": 14.0, "to": 18.5, "at": Vector3(-13.2, STOOP_Y, 9.6),
				"say": ["I moved your bed. It was in my feng shui.",
			...
			{"from": 18.5, "to": 11.0, "at": Vector3(-14.4, STOOP_Y, 11.4),
				"say": ["Podcast about a man who ate a plane. Episode four.",
